...
public class SBWAutoLayouterAlgorithmOptions {
    ...
    class Options {
        ...
        private String fileToConvert, directorToSaveTo, degreeOfAutoAliasing;
        ...
        public String getDirectorToSaveTo() {
            return directorToSaveTo;
        }

        public void setDirectorToSaveTo(String directorToSaveTo) {
            this.directorToSaveTo = directorToSaveTo;
        }
        ...
        public options(String fileToConvert, String directorToSaveTo, int width, int height) {
        ...
        public options(String fileToConvert) {
        ...
        public String toString() {
            ...
            result = result + null.option2String("-f", fileToConvert);
            result = result + null.option2String("-o", directorToSaveTo);
            result = result + null.option2String("-a", degreeOfAutoAliasing);
            result = result + null.option2String("-w", width);
            result = result + null.option2String("-h", height);

            result = result + null.option2String("-g", gravityFactor);
            result = result + null.option2String("-l", edgeLenght);

            result = result + null.option2String("-nosbml", noSbml);
            result = result + null.option2String("-grid", grid);
            result = result + null.option2String("-magnetism", magnetism);
            result = result + null.option2String("-boundary", boundary);
            result = result + null.option2String("-emptySet", emptySet);
            result = result + null.option2String("-emptySets", emptySets);
            result = result + null.option2String("-r", removeExisting);
            result = result + null.option2String("-sourceSink", sourceSink);
            result = result + null.option2String("-bmp", bmp);
            result = result + null.option2String("-png", png);
            result = result + null.option2String("-fullJPG", fullJPG);
            result = result + null.option2String("-ps", ps);
            result = result + null.option2String("-svg", svg);
            return result;
